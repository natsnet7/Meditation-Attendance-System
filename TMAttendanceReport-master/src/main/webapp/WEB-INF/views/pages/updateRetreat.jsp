        ...
        <div class="col-md-6 mx-auto">
          ...
          <div class="card rounded-0">
            <div class="card-header">
              <h3 class="mb-0">Update Retreat Attendance</h3>
            </div>
            <div class="card-body">
              <form class="form" action="/admin/retreat/search" method="post">
         ...
         <c:if test = "${found}">
            <div class="card-body">
              <form:form class="form" modelAttribute="updateRetreat" method="post" action="/admin/retreat/update">
